...
//   // await Axios.put(`${config.baseUrl}${config.nfts}/${nft.id}`, { "author": curUser.author.id, "situation": "saled", "bids": [], "deadline": null, "price": curPrice }, {
//   //   params: {},
//   // }).catch(err => {
//   //   return {
//   //     success: false,
...
//   // await Axios.put(`${config.baseUrl}${config.authors}/${curUser.author.id}`, { "nfts": nftsToUpdateCustomer }, {
//   //   params: {},
//   // }).catch(err => {
//   //   return {
//   //     success: false,
...
//     ///*chage the ownership of saling NFT with buyer's id *///
//     // await Axios.put(`${config.baseUrl}${config.nfts}/${nft.id}`, { "author": topBidder.id, "situation": "saled", "bids": [], "deadline": null, "price": curPrice }, {
//     //   params: {},
//     // }).catch(err => {
//     //   return {
//     //     success: false,
...
//     });
//     nftsToUpdateCustomer = [...nftsToUpdateCustomer, nft.id];
//     // await Axios.put(`${config.baseUrl}${config.authors}/${topBidder.id}`, { "nfts": nftsToUpdateCustomer }, {
//     //   params: {},
//     // }).catch(err => {
//     //   return {
//     //     success: false,
...
//   // await Axios.post(`${config.baseUrl}${config.activities}${multi}`, activity, {
//   //   params: {},
//   // }).catch(err => {
//   //   return {
//   //     success: false,
...
//   // try {
//   //   const { data } = await Axios.post(`${config.baseUrl}${config.nfts}/search`,
//   //     { "data": tokenURIs }, {
//   //     params: {},
//   //   });
//   //   return {
